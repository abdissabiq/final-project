...
<head>
    ...
    <link rel="icon" href="<?= base_url('assets/eShop.png');?>">
                ...
                <nav class="navbar navbar-expand-lg bg-light navbar-light py-3 py-lg-0 px-0">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        ...
                        <div class="navbar-nav ml-auto py-0">
                            <a href="<?php echo site_url('main/login#login'); ?>" class="nav-item nav-link">Login</a>
                            <a href="<?php echo site_url('main/register#reg'); ?>" class="nav-item nav-link">Register</a>
                        </div>
                    </div>
					<?php }  else { ?>
						<div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto py-0">
                            ...
                            <a href="<?= site_url('toko#toko'); ?>" class="nav-item nav-link">Toko</a>
